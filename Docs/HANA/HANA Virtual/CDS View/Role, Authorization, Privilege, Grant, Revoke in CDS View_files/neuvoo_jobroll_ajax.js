...
function buildPagination(currentPage,totalPages){
	if (totalPages > 1){
        ...
        var out = "<li " + clase + "><a onclick=\"goToPage(1)\">" + labels["first"] + "</a>\n</li>";
        out = out + "<li " + clase + "><a onclick=\"goToPage(" + (currentPage - 1) + ")\">" + labels["prev"] + "</a>\n</li>"; 
        ...
        for (var i = pmin; i <= pmax; i++) {
            ...
            out = out + "<li " + active + "><a onclick=\"goToPage(" + i + ")\">" + i + "</a>\n</li>";
        }
        clase = "";
        if (currentPage == totalPages) {
        	clase = "class='fireUI_li_inactive'";
        }
        out = out + "<li " + clase + "><a onclick=\"goToPage(" + (currentPage + 1) + ")\">" + labels["next"] + "</a>\n</li>";
        out = out + "<li " + clase + "><a onclick=\"goToPage(" + totalPages + ")\">" + labels["last"] + "</a>\n</li>";
...
function goToPage(page){
	...
	jQuery.ajax({
		url: 'http://api.neuvoo.com/apisearch',
		data: parms,
		method: 'GET',
		dataType: 'json',
		success: function (data) {
			...
			buildPagination(page,parseInt(jQuery('ul.fireUI_pagination').data('total-pages')));
...
jQuery(document).ready(function($) {
	if (jQuery('ul.fireUI_pagination').length < 1){
  	...
  	parms = parseURLParams(jQuery('ul.fireUI_pagination').data('url'));

	jQuery('#form-search').submit(function (e){
		e.preventDefault();
		parms["q"] = clean_input(jQuery(this).find('#neuvoo_keywords').val());
		parms["l"] = clean_input(jQuery(this).find('#neuvoo_location').val());
		goToPage(1);
	});
