 ...
 */
function popup_message_display_popup(popup_message_body, width, height) {
    jQuery('body').append("<div id='popup-message-window'><div id='popup-message-content'>" + popup_message_body + " <a id='popup-message-close'>X</a></div></div>");
...
Drupal.behaviors.popup_message = {
    attach: function (context) {
        ...
        // Do not show popup on mobile phones
