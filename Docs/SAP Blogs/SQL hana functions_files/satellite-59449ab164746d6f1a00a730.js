...
sap_s.lastUpdateGlobal = 'DTM_AM:2018.02.12';  // Last updater: ACR.JD
 ...
 /* percent page view (virtual page views) */
  if (sap_s.isTrackCall&&sap_s.isTrackCall.T) {
    if (typeof s_setPercentPageViewedVars=='function') {
      try{if (_satellite.settings.isStaging||_satellite.settings.notifications) {
...
/* every call */
  ...
  if (sap_s.linkType) {
    sap_s.trackEveryCall = ['contextData._account','eVar92','contextData.s_dmdbase','contextData.s_dmdbase_custom','contextData.s_dmdbase_downstream','prop73','prop72','plugins','eVar3','channel','prop5','prop50','transactionID','prop50','visitorID','eVar48','server','prop9','eVar9','eVar7','eVar46','eVar20','eVar9','eVar10','eVar15','eVar76','prop69'];
    try{
...
sap_s.track = function (params,tt,ld,navigate,event) {
  try{if (_satellite.settings.isStaging||_satellite.settings.notifications) {
    console.log('DTM: s.track: ',arguments);
  }}catch(e){};
  var s=this;
  // legacy
    s.td_tl=false;
