...
sap_s.lastUpdateGlobal = 'DTM_AM:2019.02.05';  // Last updater: ACR.JD
sap_s.dtmPropertyName = 'SAP Help Portal';
  ...
  if(sap_s.prop11){
    ...
    if (!sap_s.prop13) {
           sap_s.prop13 = sap_s.Util.getQueryParam('serp_ref') 
								       ||
                      (!document.referrer && 'Referrer Not Available')
                       ||
// TEMP (2018.02.04) Turn off logic for popping "External Referrer" to QA where high amount of this value is coming from
...
/* var dupes */
  ...
  sap_s.varDupes = ['eVar3','eVar20','eVar9','eVar10','transactionID'];
...
/* every call */
  ...
  if (sap_s.linkType) {
    sap_s.trackEveryCall = ['prop75','eVar75','contextData._account','eVar92','contextData.s_dmdbase','contextData.s_dmdbase_custom','contextData.s_dmdbase_downstream','prop73','prop72','plugins','eVar3','channel','prop5','prop50','transactionID','prop50','visitorID','eVar48','server','prop9','eVar9','eVar7','eVar46','eVar20','eVar9','eVar10','eVar15','eVar76','prop69'];
    try{
