...
function CMenu(win) {
    ...
    this.tm.stsCollapse         = "Click Here to Collapse the Tree"; // [[STATUS_TEXT_TREE_COLLAPSE]] "Trigger this link to collapse."
// c5060753; CSN: 1368986 2007; NOTE: with JExS this var can be set to true!
    this.tm.a11y                = true;
// c5060753
    this.tm.a11yEnter           = "Start of Navigation Tree"; // [[A11Y_TREE_ENTER]] "Start of the navigation tree."
    this.tm.a11yLeave           = "End of Navigation Tree"; // [[A11Y_TREE_LEAVE]]"End of the navigation tree."
