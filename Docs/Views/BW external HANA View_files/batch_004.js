...
;
try {
/* module-key = 'com.atlassian.auiplugin:internal-skatejs-0.13.16-lib-constants', location = 'node_modules/skatejs/lib/constants.js' */
...
;
try {
/* module-key = 'com.atlassian.auiplugin:internal-skatejs-0.13.16-lib-version', location = 'node_modules/skatejs/lib/version.js' */
...
h?b=Number(b):"boolean"===h&&(b=Boolean(b));void 0!==b&&(f=d.exports=b)};a.amd=!0;var e=function(a,c){c.exports="0.13.16"};"function"===typeof a&&a.amd?a(["exports","module"],e):"undefined"!==typeof f&&"undefined"!==typeof d&&e(f,d);return d.exports}.call(this);
}catch(e){WRMCB(e)};
;
try {
/* module-key = 'com.atlassian.auiplugin:internal-skatejs-0.13.16-lib-globals', location = 'node_modules/skatejs/lib/globals.js' */
...
;
try {
/* module-key = 'com.atlassian.auiplugin:internal-skatejs-0.13.16-lib-data', location = 'node_modules/skatejs/lib/data.js' */
...
;
try {
/* module-key = 'com.atlassian.auiplugin:internal-skatejs-0.13.16-lib-mutation-observer', location = 'node_modules/skatejs/lib/mutation-observer.js' */
/*
...
;
try {
/* module-key = 'com.atlassian.auiplugin:internal-skatejs-0.13.16-lib-utils', location = 'node_modules/skatejs/lib/utils.js' */
...
;
try {
/* module-key = 'com.atlassian.auiplugin:internal-skatejs-0.13.16-lib-registry', location = 'node_modules/skatejs/lib/registry.js' */
...
;
try {
/* module-key = 'com.atlassian.auiplugin:internal-skatejs-0.13.16-lib-lifecycle', location = 'node_modules/skatejs/lib/lifecycle.js' */
("undefined"===typeof window?global:window).__ba85cb72753cb44a67f124e924b0b112=function(){var n={exports:{}},l=n.exports,q={module:n,exports:l,"./constants":__c62f04354f4648f2854af3024816c116,"./data":__9e02b50b12c0ed064f4d9f357a33f49c,"./mutation-observer":__85ab6ef6197a519589a8a0c86a2b9b2a,"./registry":__4c0c6ba716a0009374f9f7dd89d84124,"./utils":__4d57054a955f37158fb149c2d875b2ee,"./constants":__c62f04354f4648f2854af3024816c116,"./data":__9e02b50b12c0ed064f4d9f357a33f49c,"./mutation-observer":__85ab6ef6197a519589a8a0c86a2b9b2a,
"./registry":__4c0c6ba716a0009374f9f7dd89d84124,"./utils":__4d57054a955f37158fb149c2d875b2ee},j;j=function(b,f,k){var j=("undefined"===typeof window?global:window).define,e,i,k=[k,f,b].filter(function(e){return"function"===typeof e})[0],f=[f,b,[]].filter(Array.isArray)[0];e=k.apply(null,f.map(function(e){return q[e]}));i=typeof e;"function"===typeof j&&j("string"===typeof b?b:"__ba85cb72753cb44a67f124e924b0b112",f,k);"string"===i?e=String(e):"number"===i?e=Number(e):"boolean"===i&&(e=Boolean(e));
void 0!==e&&(l=n.exports=e)};j.amd=!0;var o=function(b,f,k,j,e,i){function n(g,c,a){Object.defineProperty(g,a,{get:function(){return this.getAttribute(c)},set:function(a){void 0===a?this.removeAttribute(c):this.setAttribute(c,a)}})}function l(g,c,a){var e,f,d=a.name,r=a.newValue,a=a.oldValue,h="string"===typeof r,b="string"===typeof a,m=(c=c.attributes)&&c[d];!b&&h?f="created":b&&h?f="updated":b&&!h&&(f="removed");m&&"function"===typeof m[f]?e=m[f]:m&&"function"===typeof m.fallback?e=m.fallback:"function"===
typeof m?e=m:"function"===typeof c&&(e=c);e&&e(g,{type:f,name:d,newValue:void 0===r?null:r,oldValue:void 0===a?null:a})}function o(g,c){var a=s(g,c.id);if(!a.created){a.created=!0;A(g,c.prototype,!0);c.template&&!g.hasAttribute(c.resolvedAttribute)&&c.template(g);g.removeAttribute(c.unresolvedAttribute);g.setAttribute(c.resolvedAttribute,"");var e=function(a,c){return function(e){if(!c)return a(g,e,g);for(var b=e.target;b&&b!==document&&b!==g.parentNode;){var d;var f=b;d=c;B&&(f=f.cloneNode(),document.createElement("div").appendChild(f));
d=u.call(f,d);if(d)return a(g,e,b);b=b.parentNode}}};"object"===typeof c.events&&C(c.events,function(a,c){var b,d;d=c.split(" ");b=d.shift();d=d.join(" ");g.addEventListener(b,e(a,d),!!d&&("blur"===b||"focus"===b))});var f=g.attributes;c.attributes&&!t.isNativeCustomElement(c.id)&&(new window.MutationObserver(function(a){a.forEach(function(a){var b=a.attributeName,d=f[b];l(g,c,{name:b,newValue:d&&(d.value||d.nodeValue),oldValue:a.oldValue})})})).observe(g,{attributes:!0,attributeOldValue:!0});a=c.attributes;
if("object"===typeof a)for(var d in a){var b=D(d);p(a,d)&&!p(g,b)&&n(g,d,b)}d=c.attributes;if("object"===typeof d)for(var h in d)p(d,h)&&(p(d[h],"value")&&!g.hasAttribute(h))&&(a=d[h].value,a="function"===typeof a?a(g):a,g.setAttribute(h,a));b=g.attributes;d=[];a=b.length;for(h=0;h<a;h++)d.push(b[h]);for(h=0;h<a;h++)b=d[h],l(g,c,{name:b.nodeName,newValue:b.value||b.nodeValue});c.created&&c.created(g)}}function v(b,c){var a=s(b,c.id);!a.attached&&E(document,b)&&(a.attached=!0,c.attached&&c.attached(b),
a.detached=!1)}function w(b,c){var a=s(b,c.id);a.detached||(a.detached=!0,c.detached&&c.detached(b),a.attached=!1)}function x(b){for(var c=0;c<b.length;c++){var a=b[c];if(!(a.nodeType!==y.ELEMENT_NODE||a.attributes[q])){for(var e=t.getForElement(a),f=e.length,d=0;d<f;d++){var i=a,h=e[d];o(i,h);v(i,h)}a=a.childNodes||[];a.length&&x(a)}}}function z(b){for(var c=0;c<b.length;c++){var a=b[c];if(a.nodeType===y.ELEMENT_NODE){z(a.childNodes);for(var e=t.getForElement(a),f=e.length,d=0;d<f;d++)w(a,e[d])}}}
Object.defineProperty(b,"__esModule",{value:!0});var q=f.ATTR_IGNORE,s=k&&k.__esModule?k["default"]:k,t=e&&e.__esModule?e["default"]:e,D=i.camelCase,E=i.elementContains,p=i.hasOwn,A=i.inherit,C=i.objEach,y=window.Node,f=window.HTMLElement.prototype,u=f.matches||f.msMatchesSelector||f.webkitMatchesSelector||f.mozMatchesSelector||f.oMatchesSelector,B=!u.call(document.createElement("div"),"div");b.initElements=x;b.removeElements=z;b.triggerAttached=v;b.triggerAttributeChanged=l;b.triggerCreated=o;b.triggerDetached=
w};"function"===typeof j&&j.amd?j("exports ./constants ./data ./mutation-observer ./registry ./utils".split(" "),o):"undefined"!==typeof l&&o(l,__c62f04354f4648f2854af3024816c116,__9e02b50b12c0ed064f4d9f357a33f49c,__85ab6ef6197a519589a8a0c86a2b9b2a,__4c0c6ba716a0009374f9f7dd89d84124,__4d57054a955f37158fb149c2d875b2ee);return n.exports}.call(this);
}catch(e){WRMCB(e)};
;
try {
/* module-key = 'com.atlassian.auiplugin:internal-skatejs-0.13.16-lib-fix-ie-innerhtml', location = 'node_modules/skatejs/lib/fix-ie-innerhtml.js' */
...
;
try {
/* module-key = 'com.atlassian.auiplugin:internal-skatejs-0.13.16-lib-document-observer', location = 'node_modules/skatejs/lib/document-observer.js' */
...
;
try {
/* module-key = 'com.atlassian.auiplugin:internal-skatejs-0.13.16-lib-skate', location = 'node_modules/skatejs/lib/skate.js' */
...
("undefined"===typeof window?global:window).__4945108a93c7dea199ecdb0133c20132=function(){var b={};"use strict";Object.defineProperty(b,"__esModule",{value:!0});var a=__dd0dee18d8910035abf3563b0855343d,a=a&&a.__esModule?a:{"default":a};(0,a.default)("version","5.9.15");b.default="5.9.15";return b=b["default"]}.call(this);
}catch(e){WRMCB(e)};
;
try {
...
("undefined"===typeof window?global:window).__10f0939aa7f806a167ac7886fe68e4f4=function(){function c(a){return a&&a.__esModule?a:{"default":a}}function a(b,c){f=[];Array.prototype.forEach.call(document.body.children,function(a){!a.getAttribute("aria-hidden")&&!a.className.match(/\baui-layer\b/)&&(a.setAttribute("aria-hidden","true"),f.push(a))});d||(d=(0,h.default)(document.body));!0===b&&i();var e=!!a.$dim&&"false"===a.$dim.attr("aria-hidden");a.$dim&&(a.$dim.remove(),a.$dim=null);a.$dim=(0,j.default)("div").addClass("aui-blanket");
a.$dim.attr("tabindex","0");a.$dim.appendTo(document.body);e||((0,k.recomputeStyle)(a.$dim),a.cachedOverflow=d.css("overflow"),d.css("overflow","hidden"));a.$dim.attr("aria-hidden","false");c&&a.$dim.css({zIndex:c});return a.$dim}function e(){f.forEach(function(a){a.removeAttribute("aria-hidden")});a.$dim&&(a.$dim.attr("aria-hidden","true"),d&&d.css("overflow",a.cachedOverflow))}var b={};"use strict";Object.defineProperty(b,"__esModule",{value:!0});b.undim=b.dim=void 0;var h=c(__2fd777cca7fe187ff4048afabed6a6b5),
l=__0a7d4a163e3be47f52506147719b6d9c,k=__e3af25d9bced0eef741f71bd383fd36d,j=c(__2d531098c970c317a3724a30d0513040),g=c(__dd0dee18d8910035abf3563b0855343d),d,f=[],i=(0,l.getMessageLogger)("useShim",{extraInfo:"useShim has no alternative as it is now calculated by dim()."});(0,g.default)("dim",a);(0,g.default)("undim",e);b.dim=a;b.undim=e;return b}.call(this);
}catch(e){WRMCB(e)};
;
try {
...
("undefined"===typeof window?global:window).__c3a107a0f74c5ec71c09a1f1f4b838f9=function(){function j(b,h){var c,d,e;c=b.getAttribute(k)||b.getAttribute("data-aui-"+k)||window;"string"===typeof c&&(c=document.querySelector(c));e=c;c=(b.getAttribute(l)||b.getAttribute("data-aui-"+l)||m).split(" ");d=n(c,2);c=d[0];d=d[1];if(!d||"auto"===d){var a=e;d="left";if(!a||a===window||a===document)a=document.documentElement;a&&(a.nodeType&&a.nodeType===Node.ELEMENT_NODE)&&(a=a.getBoundingClientRect(),h.getBoundingClientRect().left>
a.right/2&&(d="right"))}var a=o[c+" "+d]||o[m],i=b.hasAttribute(p)||b.hasAttribute("data-aui-"+p);e=new q.default({enabled:!1,element:b,target:h,attachment:a.el,targetAttachment:a.target,classPrefix:r,constraints:[{to:e===window?"window":e,attachment:!0===i?"none":"together"}]});b.className+=" "+(s+c)+" "+(t+d);this._auiTether=e}var f={};"use strict";Object.defineProperty(f,"__esModule",{value:!0});var n;n=function(b,h){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b)){var c=[],d=!0,e=
!1,a=void 0;try{for(var i=b[Symbol.iterator](),f;!(d=(f=i.next()).done)&&!(c.push(f.value),h&&c.length===h);d=!0);}catch(g){e=!0,a=g}finally{try{if(!d&&i["return"])i["return"]()}finally{if(e)throw a;}}return c}throw new TypeError("Invalid attempt to destructure non-iterable instance");};var g=__7e39232325a0dd9c4006f7d16580518b,q=g&&g.__esModule?g:{"default":g},l="alignment",p="alignment-static",k="alignment-container",r="aui-alignment",s="aui-alignment-side-",t="aui-alignment-snap-",m="right middle",
o={"top left":{el:"bottom left",target:"top left"},"top center":{el:"bottom center",target:"top center"},"top right":{el:"bottom right",target:"top right"},"right top":{el:"top left",target:"top right"},"right middle":{el:"middle left",target:"middle right"},"right bottom":{el:"bottom left",target:"bottom right"},"bottom left":{el:"top left",target:"bottom left"},"bottom center":{el:"top center",target:"bottom center"},"bottom right":{el:"top right",target:"bottom right"},"left top":{el:"top right",
target:"top left"},"left middle":{el:"middle right",target:"middle left"},"left bottom":{el:"bottom right",target:"bottom left"},"submenu left":{el:"top left",target:"top right"},"submenu right":{el:"top right",target:"top left"}};j.prototype={destroy:function(){this._auiTether.destroy();return this},disable:function(){this._auiTether.disable();return this},enable:function(){this._auiTether.enable();return this}};f.default=j;return f=f["default"]}.call(this);
}catch(e){WRMCB(e)};
;
try {
...
("undefined"===typeof window?global:window).__200ba80704c5065142c82df092a72ea9=function(){function u(a){if(a&&a.__esModule)return a;var b={};if(null!=a)for(var d in a)Object.prototype.hasOwnProperty.call(a,d)&&(b[d]=a[d]);b.default=a;return b}function i(a){return a&&a.__esModule?a:{"default":a}}function v(a){return(0,c.default)(a).is('.checked, .aui-dropdown2-checked, [aria-checked="true"]')}function l(a,b){var d=(0,c.default)('[aria-controls="'+a.id+'"]')[0];d&&b(d)}function q(a,b){var d=(0,c.default)(a);
b?(d.attr("aria-expanded","true"),d.addClass("active aui-dropdown2-active")):(d.attr("aria-expanded","false"),d.removeClass("active aui-dropdown2-active"))}function w(a){(0,g.default)(a).set("loading-state",x);(0,g.default)(a).set("hasErrorBeenShown",a.isVisible());j.default.wrap(a).innerHTML='\n        <div class="aui-message aui-message-error aui-dropdown-error">\n            <p>'+"\u041e\u0448\u0438\u0431\u043a\u0430 \u0437\u0430\u0433\u0440\u0443\u0437\u043a\u0438 \u0432\u044b\u043f\u0430\u0434\u0430\u044e\u0449\u0435\u0433\u043e \u043c\u0435\u043d\u044e"+"</p>\n        </div>\n    "}function y(a){if(a.src&&(0,g.default)(a).get("loading-state")!==
z)(0,g.default)(a).set("loading-state",z),(0,g.default)(a).set("hasErrorBeenShown",!1),l(a,function(a){a.setAttribute("aria-busy","true")}),j.default.wrap(a).innerHTML='\n        <div class="aui-dropdown-loading">\n            <span class="spinner"></span> '+"\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430 \u0432\u044b\u043f\u0430\u0434\u0430\u044e\u0449\u0435\u0433\u043e \u043c\u0435\u043d\u044e"+"\n        </div>\n    ",(0,c.default)(a).find(".spinner").spin(),c.default.ajax(a.src).done(function(b,d,h){200===h.status?((0,g.default)(a).set("loading-state",E),j.default.wrap(a).innerHTML=b.map(function(a){var b=
a.items.map(function(a){function b(d){return a[d]?d+' ="true"':""}var d="aui-item-"+a.type;return"\n                <"+d+" "+(a["for"]?'for="'+a["for"]+'"':"")+" "+(a.href?'href="'+a.href+'"':"")+" "+b("interactive")+"\n                    "+b("checked")+" "+b("disabled")+" "+b("hidden")+">\n                    "+a.content+"\n                </"+d+">"}).join("");return"\n            <aui-section "+(a.label?'label="'+a.label+'"':"")+">\n                "+b+"\n            </aui-section>"}).join("\n"),
e.default.init(a)):w(a)}).fail(function(){w(a)}).always(function(){l(a,function(a){a.setAttribute("aria-busy","false")})})}function A(a,b){return(0,c.default)(a).find('> ul > li, > .aui-dropdown2-section > ul > li, > div[role] > .aui-dropdown2-section > div[role="group"] > ul[role] > li[role], aui-item-link, aui-item-checkbox, aui-item-radio').filter(b).children('a, button, [role="checkbox"], [role="menuitemcheckbox"], [role="radio"], [role="menuitemradio"]')}function p(a){return A(a,function(){return-1===
this.className.indexOf("hidden")&&!this.hasAttribute("hidden")})}function B(a){var b=(0,c.default)(a);b.addClass("aui-dropdown2");(0,r.supportsVoiceOver)()&&b.find('> div[role="application"]').attr("role","presentation");a.hasAttribute("data-container")&&(b.attr("data-aui-alignment-container",b.attr("data-container")),b.removeAttr("data-container"));(0,k.default)(a);a.addEventListener("aui-layer-show",function(){(0,c.default)(a).trigger("aui-dropdown2-show");var b=(0,c.default)(a),h=b.find(".hidden").addClass("aui-dropdown2-hidden"),
e=b.find(".disabled").addClass("aui-dropdown2-disabled"),f=b.find(".interactive").addClass("aui-dropdown2-interactive");a._syncClasses=function(){h.removeClass("aui-dropdown2-hidden");e.removeClass("aui-dropdown2-disabled");f.removeClass("aui-dropdown2-interactive")};A(this,function(){return true}).each(function(){var a=(0,c.default)(this);a.attr("tabindex","-1");(a.hasClass("aui-dropdown2-disabled")||a.parent().hasClass("aui-dropdown2-hidden"))&&a.attr("aria-disabled",true)});l(a,function(b){q(b,
true);b=b.getAttribute("data-dropdown2-hide-location");b=document.getElementById(b)||a.parentNode;a._returnTo=b})});a.addEventListener("aui-layer-hide",function(){(0,c.default)(a).trigger("aui-dropdown2-hide");if(a._syncClasses){a._syncClasses();delete a._syncClasses}if(a._auiAlignment){a._auiAlignment.disable();a._auiAlignment.destroy()}if(a._returnTo){a.parentNode&&a.parentNode!==a._returnTo&&a.parentNode.removeChild(a);a._returnTo.appendChild(a)}p(a).removeClass("active aui-dropdown2-active");
l(a,function(a){var b=m===true;m=false;if(b){a.focus();q(a,a.hasSubmenu&&a.hasSubmenu())}else q(a,false)});delete a.isSubmenu});b=(0,c.default)(a);b.on("keydown",function(b){if(b.keyCode===f.default.DOWN){a.focusNext();b.preventDefault()}else if(b.keyCode===f.default.UP){a.focusPrevious();b.preventDefault()}else if(b.keyCode===f.default.LEFT){if(a.isSubmenu){m=true;a.hide();b.preventDefault()}}else if(b.keyCode===f.default.ESCAPE)m=true;else if(b.keyCode===f.default.TAB){m=true;a.hide()}});b.on("click",
'a, button, [role="menuitem"], [role="menuitemcheckbox"], [role="checkbox"], [role="menuitemradio"], [role="radio"]',function(b){var h=(0,c.default)(b.currentTarget);h.attr("aria-disabled")==="true"&&b.preventDefault();if(!b.isDefaultPrevented()&&!h.is(".aui-dropdown2-interactive")){b=a;do{h=(0,k.default)(b);b=(0,k.default)(b).below();h.$el.is(".aui-dropdown2")&&h.hide()}while(b)}});b.on("mouseenter",'a, button, [role="menuitem"], [role="menuitemcheckbox"], [role="checkbox"], [role="menuitemradio"], [role="radio"]',
function(b){var h=b.currentTarget,h=h.hasSubmenu&&h.hasSubmenu();if(!b.isDefaultPrevented()&&!h)(b=(0,k.default)(a).above())&&(0,k.default)(b).hide()});a.hide();(0,c.default)(a).delegate(".aui-dropdown2-checkbox:not(.disabled):not(.aui-dropdown2-disabled)","click keydown",function(a){if((a.type==="click"||a.keyCode===f.default.ENTER||a.keyCode===f.default.SPACE)&&!a.isDefaultPrevented()){this.isInteractive()&&a.preventDefault();this.isEnabled()&&(this.isChecked()?this.uncheck():this.check())}});(0,
c.default)(a).delegate(".aui-dropdown2-radio:not(.checked):not(.aui-dropdown2-checked):not(.disabled):not(.aui-dropdown2-disabled)","click keydown",function(a){if((a.type==="click"||a.keyCode===f.default.ENTER||a.keyCode===f.default.SPACE)&&!a.isDefaultPrevented()){this.isInteractive()&&a.preventDefault();a=(0,c.default)(this);if(this.isEnabled()&&this.isChecked()===false){a.closest("ul,[role=group]").find(".aui-dropdown2-checked").not(this).each(function(){this.uncheck()});this.check()}}})}"use strict";
__c224cbc2582565ddc04950dfebb7528b;var c=i(__2fd777cca7fe187ff4048afabed6a6b5),j=i(__0f8ef3171796b22ce2811730a18040e8),F=u(__0a7d4a163e3be47f52506147719b6d9c),G=u(__4f4d08f5cd21aa65e83ce6be211355f4),n=__b30c6dc7c2e5d44f4c8c31998e708592,r=__c9dfecee744c45b52fd2e8795f004015,H=i(__c3a107a0f74c5ec71c09a1f1f4b838f9),C=i(__150d9dddd0262840eb814087b223c370),f=i(__2df6ae9f601a70792914228c0cba1eb9),k=i(__32c9c638c13fb3cc78ab29b878f9b179),g=i(__57064c5323b462d4619db8aa6f7d7eb4),e=i(__7a4f1c37715fcec19fc8ec09205ad4f4),
z="loading",x="error",E="success";(0,e.default)("aui-dropdown2-trigger",{type:e.default.type.CLASSNAME,created:function(a){function b(b){b.preventDefault();if(a.isEnabled())return b=document.getElementById(d),b.toggle(),b.isSubmenu=a.hasSubmenu(),b}var d=a.getAttribute("aria-controls");d||((d=a.getAttribute("aria-owns"))?(a.removeAttribute("aria-owns"),a.setAttribute("aria-controls",d)):G.error('Dropdown triggers need either a "aria-owns" or "aria-controls" attribute'));a.setAttribute("aria-haspopup",
!0);a.setAttribute("aria-expanded",!1);a.setAttribute("href","#");(0,c.default)(a).on("aui-button-invoke",b).on("click",b).on("keydown",function(c){var d=c.keyCode===f.default.ENTER||c.keyCode===f.default.SPACE,e=c.keyCode===f.default.RIGHT&&a.hasSubmenu(),g=(c.keyCode===f.default.UP||c.keyCode===f.default.DOWN)&&!a.hasSubmenu();if(d||e||g)(c=b(c))&&c.focusItem(0)}).on("mouseenter",function(b){b.preventDefault();if(a.isEnabled()){var b=document.getElementById(d),c=(0,g.default)(b).get("loading-state")===
"unloaded",e=(0,g.default)(b).get("hasErrorBeenShown");(c||e&&!b.isVisible())&&y(b);if(a.hasSubmenu()){b.show();b.isSubmenu=a.hasSubmenu()}return b}})},prototype:{disable:function(){this.setAttribute("aria-disabled","true")},enable:function(){this.setAttribute("aria-disabled","false")},isEnabled:function(){return"true"!==this.getAttribute("aria-disabled")},hasSubmenu:function(){return-1!==(this.className||"").split(/\s+/).indexOf("aui-dropdown2-sub-trigger")}}});(0,c.default)(document).on("mousedown",
".aui-dropdown2-trigger",function(){this.hasAttribute("resolved")||(e.default.init(this),F.getMessageLogger("Dropdown2 lazy initialisation",{removeInVersion:"6.0.0",alternativeName:"initialisation on DOM insertion",sinceVersion:"5.8.0",extraInfo:"Dropdown2 triggers should have all necessary attributes on DOM insertion",deprecationType:"JS"})())});(0,e.default)("aui-dropdown2-sub-trigger",{type:e.default.type.CLASSNAME,created:function(a){a.className+=" aui-dropdown2-trigger";e.default.init(a)}});
(0,c.default)(document).on("mouseenter",".aui-dropdown2-trigger-group a, .aui-dropdown2-trigger-group button",function(a){var b=(0,c.default)(a.currentTarget);if(!b.is(".aui-dropdown2-active")&&!b.closest(".aui-dropdown2").size()){var d=b.closest(".aui-dropdown2-trigger-group"),e=d.find(".aui-dropdown2-active");e.size()&&b.is(".aui-dropdown2-trigger")&&(e.blur(),b.trigger("aui-button-invoke"),a.preventDefault());a=d.find(":focus");a.size()&&b.is(".aui-dropdown2-trigger")&&a.blur()}});var m=!1;(0,
c.default)(window).on("resize",(0,n.debounceImmediate)(function(){(0,c.default)(".aui-dropdown2").each(function(a,b){e.default.init(b);b.isVisible()&&b.hide()})},1E3));var n={toggle:function(){this.isVisible()?this.hide():this.show()},show:function(){(0,k.default)(this).show();var a=this;l(a,function(b){var d=b&&b.hasSubmenu&&b.hasSubmenu(),e="submenu auto"===a.getAttribute("data-aui-alignment");if(!d&&e){var f=(0,c.default)(a),g=f.data("previous-data-aui-alignment");g?a.setAttribute("data-aui-alignment",
...
"submenu auto"),a.setAttribute("data-aui-alignment-static",!0)):f||(a.setAttribute("data-aui-alignment","bottom auto"),a.setAttribute("data-aui-alignment-static",!0));a._auiAlignment&&a._auiAlignment.destroy();a._auiAlignment=new H.default(a,b);a._auiAlignment.enable()});return this},hide:function(){(0,k.default)(this).hide();return this},focusNext:function(){var a=p(this),b=document.activeElement;a.last()[0]!==b&&(b=a.toArray().indexOf(b),this.focusItem(a.get(b+1)))},focusPrevious:function(){var a=
p(this),b=document.activeElement;a.first()[0]!==b&&(b=a.toArray().indexOf(b),this.focusItem(a.get(b-1)))},focusItem:function(a){var b=p(this);"number"===typeof a&&(a=b.get(a));a=(0,c.default)(a);a.focus();b.removeClass("active aui-dropdown2-active");a.addClass("active aui-dropdown2-active")},isVisible:function(){return(0,k.default)(this).isVisible()}},o={created:function(a){a=a.children[0];a.setAttribute("aria-disabled","true");a.className+=" aui-dropdown2-disabled"},removed:function(a){a=a.children[0];
a.setAttribute("aria-disabled","false");(0,c.default)(a).removeClass("aui-dropdown2-disabled")}},s={created:function(a){a.children[0].className+=" aui-dropdown2-interactive"},removed:function(a){a=a.children[0];(0,c.default)(a).removeClass("aui-dropdown2-interactive")}},D={created:function(a){var b=a.children[0];(0,c.default)(b).addClass("checked aui-dropdown2-checked");b.setAttribute("aria-checked",!0);a.dispatchEvent(new C.default("change",{bubbles:!0}))},removed:function(a){var b=a.children[0];
(0,c.default)(b).removeClass("checked aui-dropdown2-checked");b.setAttribute("aria-checked",!1);a.dispatchEvent(new C.default("change",{bubbles:!0}))}},t={created:function(a){o.created(a)},removed:function(a){o.removed(a)}};(0,e.default)("aui-item-link",{template:(0,j.default)('<a role="menuitem" tabindex="-1"><content></content></a>'),attributes:{disabled:o,interactive:s,hidden:t,href:{created:function(a,b){a.children[0].setAttribute("href",b.newValue)},updated:function(a,b){a.children[0].setAttribute("href",
b.newValue)},removed:function(a){a.children[0].removeAttribute("href")}},"for":{created:function(a){var b=a.children[0];b.setAttribute("aria-controls",a.getAttribute("for"));(0,c.default)(b).addClass("aui-dropdown2-sub-trigger")},updated:function(a){a.children[0].setAttribute("aria-controls",a.getAttribute("for"))},removed:function(a){a=a.children[0];a.removeAttribute("aria-controls");(0,c.default)(a).removeClass("aui-dropdown2-sub-trigger")}}}});(0,e.default)("aui-item-checkbox",{template:(0,j.default)('<span role="checkbox" class="aui-dropdown2-checkbox" tabindex="-1"><content></content></span>'),
attributes:{disabled:o,interactive:s,checked:D,hidden:t}});(0,e.default)("aui-item-radio",{template:(0,j.default)('<span role="radio" class="aui-dropdown2-radio" tabindex="-1"><content></content></span>'),attributes:{disabled:o,interactive:s,checked:D,hidden:t}});(0,e.default)("aui-section",{template:(0,j.default)('\n        <strong aria-role="presentation" class="aui-dropdown2-heading"></strong>\n        <div role="group">\n            <content></content>\n        </div>\n    '),attributes:{label:function(a,
b){var c=a.children[1];a.children[0].textContent=b.newValue;c.setAttribute("aria-label",b.newValue)}},created:function(a){a.className+=" aui-dropdown2-section";a.setAttribute("role","presentation")}});(0,e.default)("aui-dropdown-menu",{template:(0,j.default)('\n        <div role="application">\n            <content></content>\n        </div>\n    '),created:function(a){a.setAttribute("role","menu");a.className="aui-dropdown2 aui-style-default aui-layer";(0,g.default)(a).set("loading-state","unloaded");
e.default.init(a)},attributes:{src:{}},prototype:n,events:{"aui-layer-show":function(a){var b="unloaded"===(0,g.default)(a).get("loading-state"),c=(0,g.default)(a).get("hasErrorBeenShown");(b||c)&&y(a);if((0,g.default)(a).get("loading-state")===x)(0,g.default)(a).set("hasErrorBeenShown",!0)}}});(0,e.default)("aui-dropdown2",{type:e.default.type.CLASSNAME,created:B,prototype:n});(0,e.default)("data-aui-dropdown2",{type:e.default.type.ATTRIBUTE,created:B,prototype:n});(0,e.default)("aui-dropdown2-checkbox",
{type:e.default.type.CLASSNAME,created:function(a){var b=v(a);b&&(0,c.default)(a).addClass("checked aui-dropdown2-checked");a.setAttribute("aria-checked",b);a.setAttribute("tabindex","0");(0,r.supportsVoiceOver)()&&a.setAttribute("role","checkbox")},prototype:{isEnabled:function(){return!(null!==this.getAttribute("aria-disabled")&&"true"===this.getAttribute("aria-disabled"))},isChecked:function(){return null!==this.getAttribute("aria-checked")&&"true"===this.getAttribute("aria-checked")},isInteractive:function(){return(0,
...
(0,c.default)(this).addClass("checked aui-dropdown2-checked");(0,c.default)(this).trigger("aui-dropdown2-item-check")}}});(0,e.default)("aui-dropdown2-radio",{type:e.default.type.CLASSNAME,created:function(a){var b=v(a);b&&(0,c.default)(a).addClass("checked aui-dropdown2-checked");a.setAttribute("aria-checked",b);a.setAttribute("tabindex","0");(0,r.supportsVoiceOver)()&&a.setAttribute("role","radio")},prototype:{isEnabled:function(){return!(null!==this.getAttribute("aria-disabled")&&"true"===this.getAttribute("aria-disabled"))},
...
;
try {
/* module-key = 'com.atlassian.auiplugin:internal-bower-components-fancy-file-input-dist-fancy-file-input', location = 'bower_components/fancy-file-input/dist/fancy-file-input.js' */
("undefined"===typeof window?global:window).__42c65fc32be04a0695f9b76d4665b84c=function(){var f={exports:{}},g=f.exports,m={module:f,exports:g,jquery:__2fd777cca7fe187ff4048afabed6a6b5,jquery:__2fd777cca7fe187ff4048afabed6a6b5},d;d=function(b,a,j){var d=("undefined"===typeof window?global:window).define,c,e,j=[j,a,b].filter(function(a){return"function"===typeof a})[0],a=[a,b,[]].filter(Array.isArray)[0];c=j.apply(null,a.map(function(a){return m[a]}));e=typeof c;"function"===typeof d&&d("string"===
typeof b?b:"__42c65fc32be04a0695f9b76d4665b84c",a,j);"string"===e?c=String(c):"number"===e?c=Number(c):"boolean"===e&&(c=Boolean(c));void 0!==c&&(g=f.exports=c)};d.amd=!0;var l=this,i=function(b){function a(k,h){var c=b(k).data("FancyFileInput");if(c)return c;h=b.extend({},a.defaults,h);this.el=k;this.$el=b(k);this.$label=this.createLabel(h.buttonText);this._addLabelText();this.$clearButton=b("<button>",{text:this.$label.attr("data-ffi-clearButtonText")||h.clearButtonText,"class":"ffi-clear",type:"button",
...
("undefined"===typeof window?global:window).__afb690a989e69e0e0958267e81e20b37=function(){function y(a){if(a&&a.__esModule)return a;var b={};if(null!=a)for(var e in a)Object.prototype.hasOwnProperty.call(a,e)&&(b[e]=a[e]);b.default=a;return b}function v(a,b,t,c){c=c||[];c.hasOwnProperty("getArrowAttributes")&&E();c.hasOwnProperty("getArrowPath")&&(F(),c.hasOwnProperty("gravity")&&G());c.hasOwnProperty("onTop")&&(H(),c.onTop&&void 0===c.gravity&&(c.gravity="s"));if("undefined"===typeof b&&(b=String(Math.random()).replace(".",
""),(0,e.default)("#inline-dialog-"+b+", #arrow-"+b+", #inline-dialog-shim-"+b).length))throw"GENERATED_IDENTIFIER_NOT_UNIQUE";var d=e.default.extend(!1,v.opts,c);"w"===d.gravity&&(d.offsetX=void 0===c.offsetX?10:c.offsetX,d.offsetY=void 0===c.offsetY?0:c.offsetY);var B,k,l,g=!1,o=!1,p=!1,h,n,f=(0,e.default)('<div id="inline-dialog-'+b+'" class="aui-inline-dialog"><div class="aui-inline-dialog-contents contents"></div><div id="arrow-'+b+'" class="aui-inline-dialog-arrow arrow"></div></div>'),i=(0,
e.default)("#arrow-"+b,f),m=f.find(".contents");window.Raphael&&c&&(c.getArrowPath||c.getArrowAttributes)||f.find(".aui-inline-dialog-arrow").addClass("aui-css-arrow");d.displayShadow||m.addClass("aui-inline-dialog-no-shadow");d.autoWidth?m.addClass("aui-inline-dialog-auto-width"):m.width(d.width);m.on({mouseenter:function(){clearTimeout(k);f.unbind("mouseenter")},mouseleave:function(){r()}});var s=function(){B||(B={popup:f,hide:function(){r(0)},id:b,show:function(){q()},persistent:d.persistent?true:
false,reset:function(){var a=(0,e.default)(window).height(),a=Math.round(a*0.75);f.children(".aui-inline-dialog-contents").css("max-height",a);a=d.calculatePositions(f,n,h,d);if(a.hasOwnProperty("displayAbove")){I();a.gravity=a.displayAbove?"s":"n"}f.css(a.popupCss);if(window.Raphael&&c&&(c.getArrowPath||c.getArrowAttributes)){if(a.gravity==="s")a.arrowCss.top=a.arrowCss.top-(e.default.browser.msie?10:9);if(!f.arrowCanvas)f.arrowCanvas=Raphael("arrow-"+b,16,16);var g=d.getArrowPath,g=e.default.isFunction(g)?
g(a):g;f.arrowCanvas.path(g).attr(d.getArrowAttributes())}else{i.removeClass("aui-bottom-arrow aui-left-arrow aui-right-arrow");a.gravity==="s"&&!i.hasClass("aui-bottom-arrow")?i.addClass("aui-bottom-arrow"):a.gravity==="w"?i.addClass("aui-left-arrow"):a.gravity==="e"&&i.addClass("aui-right-arrow")}i.css(a.arrowCss);f.fadeIn(d.fadeTime,function(){});if(e.default.browser.msie&&~~e.default.browser.version<10){a=(0,e.default)("#inline-dialog-shim-"+b);a.length||(0,e.default)(f).prepend((0,e.default)('<iframe class = "inline-dialog-shim" id="inline-dialog-shim-'+
b+'" frameBorder="0" src="javascript:false;"></iframe>'));a.css({width:m.outerWidth(),height:m.outerHeight()})}}});return B},q=function(){f.is(":visible")||(l=setTimeout(function(){if(p&&o){d.addActiveClass&&(0,e.default)(a).addClass("active");g=true;if(!d.persistent){if(!A){(0,e.default)("body").bind("click."+y,function(a){(0,e.default)(a.target).closest("#inline-dialog-"+b+" .contents").length===0&&r(0)});A=true}(0,e.default)(document).on("keydown",C)}v.current=s();(0,e.default)(document).trigger("showLayer",
["inlineDialog",s()]);s().reset()}},d.showDelay))},r=function(b){if(!(typeof b==="undefined"&&d.persistent)&&typeof f.get(0)._datePickerPopup==="undefined"){o=false;if(g&&d.preHideCallback.call(f[0].popup)){b=b==null?d.hideDelay:b;clearTimeout(k);clearTimeout(l);b!=null&&(k=setTimeout(function(){A&&(0,e.default)("body").unbind("click."+y);A=false;(0,e.default)(document).off("keydown",C);d.addActiveClass&&(0,e.default)(a).removeClass("active");f.fadeOut(d.fadeTime,function(){d.hideCallback.call(f[0].popup)});
if(f.arrowCanvas){f.arrowCanvas.remove();f.arrowCanvas=null}o=g=false;(0,e.default)(document).trigger("hideLayer",["inlineDialog",s()]);v.current=null;if(!d.cacheContent)u=p=false},b))}}},j=function(a,c){var i=(0,e.default)(c);d.upfrontCallback.call({popup:f,hide:function(){r(0)},id:b,show:function(){q()}});f.each(function(){typeof this.popup!=="undefined"&&this.popup.hide()});d.closeOthers&&(0,e.default)(".aui-inline-dialog").each(function(){!this.popup.persistent&&this.popup.hide()});n={target:i};
h=a?{x:a.pageX,y:a.pageY}:{x:i.offset().left,y:i.offset().top};g||clearTimeout(l);o=true;i=function(){u=false;p=true;d.initCallback.call({popup:f,hide:function(){r(0)},id:b,show:function(){q()}});q()};if(!u){u=true;e.default.isFunction(t)?t(m,c,i):e.default.get(t,function(a,c,e){m.html(d.responseHandler(a,c,e));p=true;d.initCallback.call({popup:f,hide:function(){r(0)},id:b,show:function(){q()}});q()})}clearTimeout(k);g||q();return false};f[0].popup=s();var u=!1,x=!1,z=function(){if(!x){(0,e.default)(d.container).append(f);
x=true}},w=(0,e.default)(a);if(d.onHover)if(d.useLiveEvents)if(w.selector)(0,e.default)(document).on("mouseenter",w.selector,function(a){z();j(a,this)}).on("mouseleave",w.selector,function(){r()});else D.log("Warning: inline dialog trigger elements must have a jQuery selector when the useLiveEvents option is enabled.");else w.on({mouseenter:function(a){z();j(a,this)},mouseleave:function(){r()}});else if(!d.noBind)if(d.useLiveEvents)if(w.selector)(0,e.default)(document).on("click",w.selector,function(a){z();
g&&d.closeOnTriggerClick?f.hide():j(a,this);return false}).on("mouseleave",w.selector,function(){r()});else D.log("Warning: inline dialog trigger elements must have a jQuery selector when the useLiveEvents option is enabled.");else w.on("click",function(a){z();g&&d.closeOnTriggerClick?f.hide():j(a,this);return false}).on("mouseleave",function(){r()});var A=!1,y=b+".inline-dialog-check",C=function(a){a.keyCode===27&&r(0)};f.show=function(b,c){b&&b.stopPropagation();z();d.noBind&&(!a||!a.length)?j(b,
c===void 0?b.target:c):j(b,a)};f.hide=function(){r(0)};f.refresh=function(){g&&s().reset()};f.getOptions=function(){return d};return f}function u(a){var a=(0,e.default)(a),b=e.default.extend({left:0,top:0},a.offset());return{left:b.left,top:b.top,width:a.outerWidth(),height:a.outerHeight()}}function J(a,b,t,c){var d,h,k,l,g,o,p,j,n=e.default.isFunction(c.offsetX)?c.offsetX(a,b,t,c):c.offsetX,f=e.default.isFunction(c.offsetY)?c.offsetY(a,b,t,c):c.offsetY;e.default.isFunction(c.arrowOffsetX)&&c.arrowOffsetX(a,
b,t,c);t=e.default.isFunction(c.arrowOffsetY)?c.arrowOffsetY(a,b,t,c):c.arrowOffsetY;g="body"!==c.container.toLowerCase();k=(0,e.default)(c.container);c=g?(0,e.default)(c.container).parent():(0,e.default)(window);l=g?k.offset():{left:0,top:0};g&&c.offset();d=b.target;g=d.offset();h=d[0].getBBox&&d[0].getBBox();b=c.scrollTop();j=c.scrollLeft();c.width();c=c.height();p=k.width();k.height();k=g.top-l.top;l=g.left-l.left;g=h?h.width:d.outerWidth();o=h?h.height:d.outerHeight();d=a.width();h=a.height();
var i=10,m=a.find(".arrow").outerHeight(),s=k-b,q=l-j,a=Math.floor(o/2);j=Math.floor(h/2);o=Math.floor(m/2);p=!(p-q-g-n-i>=d)&&q-n-i>=d?"e":"w";q=s+a-o;m=c-q-m;i=Math.min(i,q-5);i=Math.min(i,m-5);m=s+a;s=Math.max(m-i,0);m=Math.max(c-m-i,0);j-f>s?(n={top:b+i,left:"w"===p?l+g+n:l-d-n},f={top:k+a-(n.top+o)}):j+f>m?(n={top:b+c-h-i,left:"w"===p?l+g+n:l-d-n},f={top:k+a-(n.top+o)}):(n={top:k+a-j+f,left:"w"===p?l+g+n:l-d-n},f={top:j-o+t});return{gravity:p,popupCss:n,arrowCss:f}}function K(a,b,h,c){var d=
e.default.isFunction(c.offsetX)?c.offsetX(a,b,h,c):c.offsetX,j=e.default.isFunction(c.offsetY)?c.offsetY(a,b,h,c):c.offsetY,k=e.default.isFunction(c.arrowOffsetX)?c.arrowOffsetX(a,b,h,c):c.arrowOffsetX,l=u(window),g=u(b.target),b=u(a),a=u(a.find(".aui-inline-dialog-arrow")),o=g.left+g.width/2,p=(window.pageYOffset||document.documentElement.scrollTop)+l.height;b.top=g.top+g.height+~~j;b.left=g.left+~~d;d=l.width-(b.left+b.width+10);a.left=o-b.left+~~k;a.top=-(a.height/2);k=g.top>b.height;if(k=!(b.top+
b.height<p)&&k||k&&"s"===c.gravity)b.top=g.top-b.height-a.height/2,a.top=b.height;c.isRelativeToMouse?0>d?(b.right=10,b.left="auto",a.left=h.x-(l.width-b.width)):(b.left=h.x-20,a.left=h.x-b.left):0>d?(b.right=10,b.left="auto",h=l.width-b.right-b.width,a.right="auto",a.left=o-h-a.width/2):b.width<=g.width/2&&(a.left=b.width/2,b.left=o-b.width/2);return{gravity:k?"s":"n",displayAbove:k,popupCss:{left:b.left,top:b.top,right:b.right},arrowCss:{left:a.left,top:a.top,right:a.right}}}var x={};Object.defineProperty(x,
"__esModule",{value:!0});var h=__2fd777cca7fe187ff4048afabed6a6b5,e=h&&h.__esModule?h:{"default":h},h=y(__0a7d4a163e3be47f52506147719b6d9c),D=y(__4f4d08f5cd21aa65e83ce6be211355f4),j=__dd0dee18d8910035abf3563b0855343d,j=j&&j.__esModule?j:{"default":j};v.opts={onTop:!1,responseHandler:function(a){return a},closeOthers:!0,isRelativeToMouse:!1,addActiveClass:!0,onHover:!1,useLiveEvents:!1,noBind:!1,fadeTime:100,persistent:!1,hideDelay:1E4,showDelay:0,width:300,offsetX:0,offsetY:10,arrowOffsetX:0,arrowOffsetY:0,
container:"body",cacheContent:!0,displayShadow:!0,autoWidth:!1,gravity:"n",closeOnTriggerClick:!1,preHideCallback:function(){return!0},hideCallback:function(){},initCallback:function(){},upfrontCallback:function(){},calculatePositions:function(a,b,e,c){c=c||{};return("w"===c.gravity?J:K)(a,b,e,c)},getArrowPath:function(a){return"s"===a.gravity?"M0,8L8,16,16,8":"M0,8L8,0,16,8"},getArrowAttributes:function(){return{fill:"#fff",stroke:"#ccc"}}};var v=h.construct(v,"Inline dialog constructor",{alternativeName:"inline dialog 2"}),
I=h.getMessageLogger("displayAbove","[remove version]",{alternativeName:"gravity",extraInfo:"See https://ecosystem.atlassian.net/browse/AUI-2197."}),H=h.getMessageLogger("onTop","[remove version]",{alternativeName:"gravity",extraInfo:"See https://ecosystem.atlassian.net/browse/AUI-2197."}),E=h.getMessageLogger("getArrowAttributes","[remove version]",{extraInfo:"See https://ecosystem.atlassian.net/browse/AUI-1362."}),F=h.getMessageLogger("getArrowPath","[remove version]",{extraInfo:"See https://ecosystem.atlassian.net/browse/AUI-1362."}),
G=h.getMessageLogger("getArrowPath does not support gravity","[remove version]",{extraInfo:"See https://ecosystem.atlassian.net/browse/AUI-2197."});(0,j.default)("InlineDialog",v);x.default=v;return x=x["default"]}.call(this);
}catch(e){WRMCB(e)};
;
try {
...
function y(a){a.forEach(function(a,c){var d=(0,e.default)(a),f=d.find(".tabs-menu").first(),g=f.find("li:not(.aui-tabs-responsive-trigger-item)"),h=f.find(".aui-tabs-responsive-trigger").parent(),o=h.find("a"),k=o.attr("aria-controls"),k=(0,e.default)(document).find("#"+k).attr("aria-checked",!1),i=0<k.length,j=l.totalTabsWidth(g,k)>d.outerWidth();!i&&j&&(h=l.createResponsiveDropdownTrigger(f,c),k=l.createResponsiveDropdown(d,c));o.attr("aria-controls","aui-tabs-responsive-dropdown-"+c);o.attr("id",
"aui-tabs-responsive-trigger-"+c);o.attr("href","aui-tabs-responsive-trigger-"+c);k.attr("id","aui-tabs-responsive-dropdown-"+c);j&&(f=l.moveVisibleTabs(g.toArray(),d,h),f=l.totalVisibleTabWidth(f),d=d.outerWidth()-f-h.outerWidth(!0),0<d&&(f=k.find("li"),l.moveInvisibleTabs(f.toArray(),d,h)),k.on("click","a",x));i&&!j&&(k.find("li").each(function(){l.moveTabOutOfDropdown((0,e.default)(this),h)}),l.removeResponsiveDropdown(k,h))})}function z(a){var b=(0,e.default)(a);a.setAttribute("role","application");
if(!b.data("aui-tab-events-bound")){var c=b.children("ul.tabs-menu");c.attr("role","tablist");c.children("li").attr("role","presentation");c.find("> .menu-item a").each(function(){var a=(0,e.default)(this),b=a.attr("href");(0,C.default)(a);a.attr("role","tab");(0,e.default)(b).attr("aria-labelledby",a.attr("id"));a.parent().hasClass("active-tab")?a.attr("aria-selected","true"):a.attr("aria-selected","false")});c.on("click","a",x);b.data("aui-tab-events-bound",!0);[].slice.call(a.querySelectorAll(".tabs-pane")).forEach(D)}}
function D(a){a.setAttribute("role","tabpanel");a.setAttribute("aria-hidden",(0,e.default)(a).hasClass("active-pane")?"false":"true")}var p={};"use strict";Object.defineProperty(p,"__esModule",{value:!0});__0f8ef3171796b22ce2811730a18040e8;var q;var i=__4f4d08f5cd21aa65e83ce6be211355f4;if(i&&i.__esModule)q=i;else{var t={};if(null!=i)for(var n in i)Object.prototype.hasOwnProperty.call(i,n)&&(t[n]=i[n]);t.default=i;q=t}var E=j(__b30c6dc7c2e5d44f4c8c31998e708592),e=j(__2fd777cca7fe187ff4048afabed6a6b5),
C=j(__4306cc139d3b1642343a6c801ae42dc7);n=j(__dd0dee18d8910035abf3563b0855343d);var F=j(__dbdff3b1954801b9e0b97fd59b0289e8),r=j(__7a4f1c37715fcec19fc8ec09205ad4f4),s=window.skateTemplateHtml,A=/#.*/,B="_internal-aui-tabs-",l={totalTabsWidth:function(a,b){var c=this.totalVisibleTabWidth(a),d=0;b.find("li").each(function(a,b){d+=parseInt(b.getAttribute("data-aui-tab-width"))});return c+d},totalVisibleTabWidth:function(a){var b=0;a.each(function(a,d){b+=(0,e.default)(d).outerWidth()});return b},removeResponsiveDropdown:function(a,
b){a.remove();b.remove()},createResponsiveDropdownTrigger:function(a,b){a.append('<li class="menu-item aui-tabs-responsive-trigger-item"><a class="aui-dropdown2-trigger aui-tabs-responsive-trigger aui-dropdown2-trigger-arrowless" id="aui-tabs-responsive-trigger-'+b+'" aria-haspopup="true" aria-controls="aui-tabs-responsive-dropdown-'+b+'" href="aui-tabs-responsive-dropdown-'+b+'">...</a></li>');return a.find(".aui-tabs-responsive-trigger-item")},createResponsiveDropdown:function(a,b){a.append('<div class="aui-dropdown2 aui-style-default aui-tabs-responsive-dropdown" id="aui-tabs-responsive-dropdown-'+
b+'"><ul></ul></div>');return a.find("#aui-tabs-responsive-dropdown-"+b)},findNewVisibleTabs:function(a,b,c){for(var d=0,f=0;d+c<=b&&f<a.length;f++)var g=(0,e.default)(a[f]).outerWidth(!0),d=d+g;return a.slice(0,f-1)},moveVisibleTabs:function(a,b,c){for(var d=c.find("a").attr("aria-controls"),d=(0,e.default)("#"+d),b=this.findNewVisibleTabs(a,b.outerWidth(),c.parent().outerWidth(!0)),f=b.length-1,g=a.length-1;g>=f;g--){var h=(0,e.default)(a[g]);this.moveTabToResponsiveDropdown(h,d,c)}return(0,e.default)(b)},
moveTabToResponsiveDropdown:function(a,b,c){var d=a.find("a");a.attr("data-aui-tab-width",a.outerWidth(!0));d.addClass("aui-dropdown2-radio aui-tabs-responsive-item");a.hasClass("active-tab")&&(d.addClass("aui-dropdown2-checked"),c.addClass("active-tab"));b.find("ul").prepend(a)},moveInvisibleTabs:function(a,b,c){for(var d=0;0<b&&d<a.length;d++){var f=(0,e.default)(a[d]),g=parseInt(f.attr("data-aui-tab-width"),10);g<b&&this.moveTabOutOfDropdown(f,c);b-=g}},moveTabOutOfDropdown:function(a,b){a.find("a").hasClass("aui-dropdown2-checked")&&
(a.addClass("active-tab"),b.removeClass("active-tab"));a.children("a").removeClass("aui-dropdown2-radio aui-tabs-responsive-item aui-dropdown2-checked");b.before(a)}},m={setup:function(){var a=(0,E.default)(y,200),b=(0,e.default)('.aui-tabs.horizontal-tabs[data-aui-responsive]:not([data-aui-responsive="false"]), aui-tabs[responsive]:not([responsive="false"])').toArray();y(b);(0,e.default)(window).resize(function(){a(b)});var c=(0,e.default)(".aui-tabs:not(.aui-tabs-disabled)");c.each(function(){z(this)});
for(var d=0,f=c.length;d<f;d++){var g=c.eq(d),h=c.get(d);if(v(g)&&window.localStorage)if(g.attr("id")){if(g=window.localStorage.getItem(w(g)))(h=h.querySelector('a[href$="'+g+'"]'))&&u(h)}else q.warn("A tab group must specify an id attribute if it specifies data-aui-persist.")}(0,e.default)(".aui-tabs.vertical-tabs").find("a").each(function(){var a=(0,e.default)(this);a.attr("title")||(0,F.default)(a)&&a.attr("title",a.text())})},change:function(a){var a=(0,e.default)(a),b=a.closest(".aui-tabs");
u(a);v(b)&&window.localStorage&&(b=a.closest(".aui-tabs"),b.attr("id")?(a=a.attr("href"))&&window.localStorage.setItem(w(b),a):q.warn("A tab group must specify an id attribute if it specifies data-aui-persist."))}};(0,e.default)(m.setup);(0,r.default)("aui-tabs",{created:function(a){(0,e.default)(a).addClass("aui-tabs horizontal-tabs");r.default.init(a);z(a)},template:s('<ul class="tabs-menu">','<content select="li[is=aui-tabs-tab]"></content>',"</ul>",'<content select="aui-tabs-pane"></content>'),
prototype:{select:function(a){a=(0,e.default)(this.querySelectorAll("aui-tabs-pane")).index(a);-1<a&&m.change(this.querySelectorAll("li[is=aui-tabs-tab]")[a].children[0]);return this}}});var G=(0,r.default)("aui-tabs-tab",{"extends":"li",created:function(a){(0,e.default)(a).addClass("menu-item")},template:s('<a href="#">',"<strong>","<content></content>","</strong>","</a>")});(0,r.default)("aui-tabs-pane",{attached:function(a){var b=(0,e.default)((0,e.default)(a).closest("aui-tabs").get(0)),c=(0,
e.default)(a),b=b.find("aui-tabs-pane").index(c),d=new G,f=(0,e.default)(d);c.addClass("tabs-pane");d.firstChild.setAttribute("href","#"+a.id);s.wrap(d).textContent=c.attr("title");0===b&&c.addClass("active-pane");c.hasClass("active-pane")&&f.addClass("active-tab");c.siblings("ul").append(d)},template:s("<content></content>")});(0,n.default)("tabs",m);p.default=m;return p=p["default"]}.call(this);
}catch(e){WRMCB(e)};
;
try {
...
define("confluence/page-message",["ajs"],function(a){var c={_getQueryString:function(){return window.location.search},displayPageMessage:function(){var d=c._getQueryString(),b=a.Meta.get("editing-user");-1!==d.indexOf("editingLocked")&&b?a.MessageHandler.flag({type:"info",title:"\u041d\u0435\u0432\u043e\u0437\u043c\u043e\u0436\u043d\u043e \u0440\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u0442\u044c",body:a.format("\u0421\u043e\u0432\u043c\u0435\u0441\u0442\u043d\u043e\u0435 \u0440\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435 \u0441\u0435\u0439\u0447\u0430\u0441 \u043d\u0430\u0445\u043e\u0434\u0438\u0442\u0441\u044f \u0432\u043d\u0435 \u0441\u0435\u0442\u0438, \u0430 {0} \u0440\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u0443\u0435\u0442 \u044d\u0442\u0443 \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0443. \u041f\u043e\u0432\u0442\u043e\u0440\u0438\u0442\u0435 \u043f\u043e\u043f\u044b\u0442\u043a\u0443 \u0447\u0435\u0440\u0435\u0437 \u043d\u0435\u0441\u043a\u043e\u043b\u044c\u043a\u043e \u043c\u0438\u043d\u0443\u0442.",b),close:"manual"}):-1!==d.indexOf("editingFailed")&&a.MessageHandler.flag({type:"info",title:"\u041d\u0435\u0432\u043e\u0437\u043c\u043e\u0436\u043d\u043e \u0440\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u0442\u044c",
body:a.format("\u0421\u0435\u0439\u0447\u0430\u0441 \u0440\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435 \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u043e. \u041f\u043e\u0432\u0442\u043e\u0440\u0438\u0442\u0435 \u043f\u043e\u043f\u044b\u0442\u043a\u0443 \u0447\u0435\u0440\u0435\u0437 \u043d\u0435\u0441\u043a\u043e\u043b\u044c\u043a\u043e \u043c\u0438\u043d\u0443\u0442.",b),close:"manual"})}};return c});require("confluence/module-exporter").safeRequire("confluence/page-message",function(a){require("ajs").toInit(a.displayPageMessage)});
}catch(e){WRMCB(e)};
;
try {
...
c);g.sessionFail(a,f)})}},sessionFail:function(a,f){if(!a){var c=e(".aui-dialog:visible");if(c.length)a=c.find(".dialog-panel-body").empty(),c.find(".aui-button").attr("disabled","disabled");else throw Error("sessionFail method really expected a visible dialog about now :/");}f||(f=b.format("\u0412\u0440\u0435\u043c\u044f \u0441\u0435\u0430\u043d\u0441\u0430 \u0438\u0441\u0442\u0435\u043a\u043b\u043e. {0}\u041f\u0435\u0440\u0435\u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u0435{1} \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0443 \u0438 \u043f\u043e\u043f\u0440\u043e\u0431\u0443\u0439\u0442\u0435 \u0437\u0430\u043d\u043e\u0432\u043e.",'<a class="reload" href="">',"</a>"),a.on("click","a.reload",function(){g.location.reload()}));b.messages.warning(a,{body:f,closeable:!1,shadowed:!0})},Binder:{placeFocus:function(){var a,
...
Confluence.Templates.Labels.dialogLabels = function(opt_data, opt_ignored) {
  ...
  for (var labelIndex18 = 0; labelIndex18 < labelListLen18; labelIndex18++) {
    ...
    output += '<li class="aui-label ' + ((opt_data.editable) ? 'aui-label-closeable aui-label-split' : '') + '" data-label-id="' + soy.$$escapeHtml(labelData18.id) + '"><a class="aui-label-split-main" href="' + soy.$$escapeHtml("/wiki") + soy.$$escapeHtml(labelData18.link) + '" rel="tag">' + ((! labelData18.prefix || labelData18.prefix == 'global' || labelData18.prefix == 'team') ? soy.$$escapeHtml(labelData18.name) : soy.$$escapeHtml(labelData18.prefix) + ':' + soy.$$escapeHtml(labelData18.name)) + '</a>' + ((opt_data.editable) ? '<span class="aui-label-split-close"><span tabindex="0" class="aui-icon aui-icon-close"  title="' + soy.$$escapeHtml("\u0423\u0434\u0430\u043b\u0438\u0442\u044c \u043c\u0435\u0442\u043a\u0443") + '" original-title="' + soy.$$escapeHtml("\u0423\u0434\u0430\u043b\u0438\u0442\u044c \u043c\u0435\u0442\u043a\u0443") + '">' + soy.$$escapeHtml("\u0423\u0434\u0430\u043b\u0438\u0442\u044c \u043c\u0435\u0442\u043a\u0443") + '</span></span>' : '') + '</li>';
  }
  return output;
};
if (goog.DEBUG) {
...
-1,u=function(c){for(var b=a("span").addClass("item-action"),c=c.keys[0],d=0;d<c.length;d++){d>0&&b.append(p("\u0437\u0430\u0442\u0435\u043c"));for(var e=b,h=c[d].split("+"),g=0;g<h.length;g++){g>0&&e.append(p("+"));for(var i=e,j=h[g].split(".."),f=0;f<j.length;f++){f>0&&i.append(p("\u0434\u043e"));i.append(t(j[f]))}}}return b},t=function(c){var b=a("kbd");switch(c){case "Shift":case "Sh":b.text("Shift");b.addClass("modifier-key");
...
b=e(c).children(".shortcutsmenu");a.Meta.get("remote-user")&&c.find(".keyboard-shortcut-dialog-panel-header").append(k.Templates.KeyboardShortcutsDialog.keyboardShortcutEnabledCheckbox());b.append(m("\u041e\u0431\u0449\u0438\u0435 \u043a\u043e\u043c\u0431\u0438\u043d\u0430\u0446\u0438\u0438 \u043a\u043b\u0430\u0432\u0438\u0448",["global"],l));b.append(m("\u0421\u0442\u0440\u0430\u043d\u0438\u0446\u0430 / \u0414\u0435\u0439\u0441\u0442\u0432\u0438\u044f \u0441\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u044f \u0432 \u0431\u043b\u043e\u0433\u0435",["viewcontent","viewinfo"],l));return c}());d.addPanel("\u0420\u0435\u0434\u0430\u043a\u0442\u043e\u0440",function(){var c=e(n.KeyboardShortcutsDialog.keyboardShortcutPanel({panelId:"editor-shortcuts-panel"})),
b=e(c).children(".shortcutsmenu");b.append(m("\u0424\u043e\u0440\u043c\u0430\u0442\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435 \u0411\u043b\u043e\u043a\u0430",["tinymce.block"],l));b.append(m("\u0420\u0430\u0441\u0448\u0438\u0440\u0435\u043d\u043d\u043e\u0435 \u0424\u043e\u0440\u043c\u0430\u0442\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435",["tinymce.rich"],l));b.append(m("\u0420\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435 \u0414\u0435\u0439\u0441\u0442\u0432\u0438\u0439",["tinymce.actions"],l));return c}());d.addCancel("\u0417\u0430\u043a\u0440\u044b\u0442\u044c",function(){a.debug("Hiding Shortcuts help");d.hide();return false});d.popup.element.find(".dialog-title").prepend(n.KeyboardShortcutsDialog.keyboardShortcutHelpLink());
...
Confluence.Templates.KeyboardShortcutsDialog.keyboardShortcutHelpLink = function(opt_data, opt_ignored) {
  return '' + Confluence.Templates.Dialog.customHelpLink({href: '' + soy.$$escapeHtml("https://docs.atlassian.com/confluence/docs-510/Keyboard+Shortcuts"), text: '' + soy.$$escapeHtml("\u0421\u043c\u043e\u0442\u0435\u0440\u0442\u044c \u0432\u0441\u0435 \u0441\u043e\u0447\u0435\u0442\u0430\u043d\u0438\u044f")});
};
if (goog.DEBUG) {
...
" "+this.classNames.EDIT_ROW);this.trigger(this._event.RENDER,this.$el,a.values);this.$el.trigger(this._event.CONTENT_REFRESHED,[this.$el]);return this},renderOperations:function(a){var b=(0,c.default)('<td class="aui-restfultable-operations" />');a?b.append((0,c.default)('<input class="aui-button" type="submit" />').attr({accesskey:this.submitAccessKey,value:"\u041e\u0431\u043d\u043e\u0432\u0438\u0442\u044c"})).append((0,c.default)('<a class="aui-button aui-button-link" href="#" />').addClass(this.classNames.CANCEL).text("\u041e\u0442\u043c\u0435\u043d\u0438\u0442\u044c").attr({accesskey:this.cancelAccessKey})):
b.append((0,c.default)('<input class="aui-button" type="submit" />').attr({accesskey:this.submitAccessKey,value:"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c"}));return b.add((0,c.default)('<td class="aui-restfultable-status" />').append((0,o.default)()))}});return g=g["default"]}.call(this);
}catch(e){WRMCB(e)};
;
try {
...
"\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430"}}});g.ClassNames=r.default;g.CustomCreateView=k.default;g.CustomEditView=h.default;g.CustomReadView=j.default;g.DataKeys=s.default;g.EditRow=t.default;g.EntryModel=p.default;g.Events=u.default;g.Row=q.default;g.Throbber=v.default;(0,w.default)("RestfulTable",g);m.default=g;return m=m["default"]}.call(this);
}catch(e){WRMCB(e)};
;
try {
